...
public class MCreatorCheatmenublock extends Elementsguitesting.ModElement {
	@ObjectHolder("guitesting:cheatmenublock")
	public static final Block block = null;
	@ObjectHolder("guitesting:cheatmenublock")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public MCreatorCheatmenublock(Elementsguitesting instance) {
		super(instance, 21);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cheatmenublock"));
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("cheatmenublock");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cheatmenublock");
		}
