...
public class MCreatorRainoff extends Elementsguitesting.ModElement {
	public MCreatorRainoff(Elementsguitesting instance) {
		super(instance, 18);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorRainoff!");
			return;
		}
